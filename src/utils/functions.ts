...
export const formatDateIndonesia = (string = '2020-01-01') => {
  ...
  const convertedMonth = monthListIndonesia[month as '01'];

  return `${convertedDate} ${convertedMonth} ${year}`;
};

export function sortObjectByStringAscending(
...
export function sortObjectByStringDescending(
  array: Array<Record<string, string>>,
  sortAccessor: string,
) {
  return array.sort((a, b) => {
...
export function sortObjectByDateAscending(
  array: Array<Record<string, string>>,
  sortAccessor: string,
) {
  return array.sort((a, b) => {
...
export function sortObjectByDateDescending(
  array: Array<Record<string, string>>,
  sortAccessor: string,
) {
  return array.sort((a, b) => {
